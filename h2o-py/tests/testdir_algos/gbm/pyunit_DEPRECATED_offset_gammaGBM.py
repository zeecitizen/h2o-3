...
def offset_gamma():
    ...
    assert abs(0.9133843 - predictions.min()) < 0.005, "expected prediction min to be {0}, but got {1}". \
        format(0.9133843, predictions.min())
    assert abs(392.6667 - predictions.max()) < 1.2, "expected prediction max to be {0}, but got {1}". \
